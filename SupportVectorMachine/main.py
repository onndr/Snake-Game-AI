...
from model import game_state_to_data_sample, train_svm, gather_all_saves, saves_to_data_samples, SVM
...
def main():
    ...
    while len(scores) != 50:
        pygame.time.delay(50)  # Adjust game speed, decrease to test your agent and model quickly
...
class BehavioralCloningAgent:
    def __init__(self, block_size, bounds):
        ...
        data_samples = saves_to_data_samples(saves, 4, 5000)
